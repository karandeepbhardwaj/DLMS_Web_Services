...
public class McgServer {
	...
	public static void receive(McgLibImpl implementation) {
	...
	public static void main(String[] args) {
		...
		McgLibImpl mcgStub = new McgLibImpl();
		Runnable task = () -> {
			receive(mcgStub);
		};
		Endpoint endpoint = Endpoint.publish("http://localhost:8081/comp", mcgStub);
