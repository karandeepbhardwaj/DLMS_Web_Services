...
public class MonServer {
	...
	public static void receive(MonLibImpl implementation) {
	...
	public static void main(String[] args) {
		...
		MonLibImpl monStub = new MonLibImpl();
		Runnable task = () -> {
			receive(monStub);
		};
		Endpoint endpoint = Endpoint.publish("http://localhost:8082/comp", monStub);
